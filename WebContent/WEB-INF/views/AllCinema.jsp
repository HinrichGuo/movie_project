...
${pm }
	...
	<%-- 测试：${requestScope.data} --%>
	<%-- 	测试数据：data  ${requestScope.films } --%>
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						...
						<li class=""><a href="AddMovie.jsp"> <i
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						...
						<li class=""><a href="form-wizard.jsp"> <i
						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<form action="${pageContext.request.contextPath }/LikeCinema"
										method="post">
										<table width="100%" class="CSSearchTbl" cellpadding="0"
											cellspacing="0" align="center">
											<tr>
												<td class="left">影院名称：</td>
												<td class="right" ><input type="text" size="32"  name="cinemaName" /></td>
									...
									<div>
										...
										<table id="sample-table-2"
											...
											<tbody>
											<c:forEach items="${pm.data }" var="Cinema">
												<tr>
												...
												<td><img style="width: 100px; height: 80px;"
													src="/upload/${Cinema.cinemaLogo}" >
												</td>
												<td class="hidden-480">${Cinema.cinemaName}</td>
												<td class="hidden-480">${Cinema.cinemaIntro}</td>
												<td>
													...
													<script type="text/javascript">
														...
														<!-- 详细信息 以及影评发布-->
														<a href="${pageContext.request.contextPath}/quaryOneCinema?id=${Cinema.id}" role="button" class="blue"
															data-toggle="modal">
														...
														<!-- 修改页面 -->
													<a href="javaScript:void(0)" onClick="fun_update()"role="button" class="blue"
															data-toggle="modal">
														...
														<a href="${pageContext.request.contextPath}/deleteCinema?id=${Cinema.id}" id="deleteCinema"
															 role="button"
