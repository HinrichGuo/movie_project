...
$(document).ready(function() {
	...
	// A,B,C 代表显示的数据
	var line_title = ["票房总数"]; //曲线名称
	var y_label = "票数"; //Y轴标题
	var x_label = "电影院"; //X轴标题
	var x = ["电影院1","电影院2","电影院3","电影院4","电影院5","电影院6"]; //定义X轴刻度值
	var title = "这是标题12"; //统计图标标题
	j.jqplot.diagram.base("chart1", data, line_title, "电影院总票房", x, x_label, y_label, data_max, 1);
...
$(document).ready(function() {
	//所有显示的数据
	var data = [[1,2,3,4,5,6,7,8,9],[3,6,8,1,11,22,4,21,6],[1,12,2,3,4,5,1],[12,32,1,2,4,3,10]];
	var data_max = 30; //Y轴最大刻度
	// A,B,C 代表显示的数据
	...
	j.jqplot.diagram.base("chart2", data, line_title, "影片票房", x, x_label, y_label, data_max, 2);
	});
</script>
<!-- lry -->
	</head>
...
<!-- lry -->
	<%--  ${requestScope.films } --%>
	<%-- <c:forEach items="${films}" var="data">
		<h1> 哈哈哈哈哈哈哈 ${data}</h1>	
	</c:forEach>  --%>
<div id="chart1"></div>
<hr>
			...
			<div class="block full">
				Bars Chart Title
					<div class="block-title">
						<h2>饼状图</h2> </div>
					<div id="chart-pie2" style="height: 380px;"></div>
			</div>
		</div>
	</div>
</div> -->
<!-- <script type="text/javascript">
function drawBars2() {
	var dom = document.getElementById("chart-pie2");
