...
public class Cinema {
	...
	public Cinema(Integer id, String cinemaName, String cinemaLogo, String cinemaIntro, Integer cinemaaddressId,
			String cinemaIsvip, String cinemaBlack1, String cinemaBlack2) {
		super();
		this.id = id;
		...
		this.cinemaaddressId = cinemaaddressId;
		this.cinemaIsvip = cinemaIsvip;
		this.cinemaBlack1 = cinemaBlack1;
		this.cinemaBlack2 = cinemaBlack2;
	}
	...
	public String toString() {
		return "Cinema [id=" + id + ", cinemaName=" + cinemaName + ", cinemaLogo=" + cinemaLogo + ", cinemaIntro="
				+ cinemaIntro + ", cinemaaddressId=" + cinemaaddressId + ", cinemaIsvip=" + cinemaIsvip
				+ ", cinemaBlack1=" + cinemaBlack1 + ", cinemaBlack2=" + cinemaBlack2 + "]";
	}
